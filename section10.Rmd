...
penn <- counties_2024 |> 
  ...
  scale_color_manual(values = c("DEM" = "blue", "REP" = "red")) +
  theme_void() +
  labs(title = "Voting Shifts in Pennsylvania")

# Check county-level shifts in Arizona between 2024 and 2020. 
arizona<- counties_2024 |> 
...
nevada <- counties_2024 |> 
  ...
  scale_color_manual(values = c("DEM" = "blue", "REP" = "red")) +
  theme_void() +
  labs(title = "Voting Shifts in Nevada")
...
wisconsin <-counties_2024 |> 
  ...
  scale_color_manual(values = c("DEM" = "blue", "REP" = "red")) +
  theme_void() +
  labs(title = "Voting Shifts in Wisconsin")

# Check county-level shifts in Georgia between 2024 and 2020. 
georgia <- counties_2024 |> 
...
northcarolina <- counties_2024 |> 
  ...
  scale_color_manual(values = c("DEM" = "blue", "REP" = "red")) +
  theme_void() +
  labs(title = "Voting Shifts in North Carolina")

ggarrange(nevada, wisconsin, penn, northcarolina, georgia, michigan, arizona)

library(ggpubr)

ggarrange(
  nevada, wisconsin, penn, northcarolina, georgia, michigan, arizona,
  ncol = 2, nrow = 4,  # Arrange in 4 columns and 2 rows
